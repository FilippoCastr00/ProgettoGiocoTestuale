package TextAdventure.Livello1;
    ...
    public void LivelloUno() {
        ...
        for (int i = 1; i > 0;) {
            ...
            if (risposta.equalsIgnoreCase("media")) {
                ...
                //domanda media 5
                System.out.println("5)Quando si definisce un metodo in una sottoclasse che esiste già nella superclasse, questo processo è noto come:");
             ...
             if (risposta.equalsIgnoreCase("difficile")) {
                ...
                //domanda difficile 2
                System.out.println("2)Qual è il risultato di marcare un metodo come abstract in una classe non astratta in Java?");
                System.out.println("A) Compilazione riuscita, ma il metodo non può essere invocato. \n B) Errore di compilazione. \n C) Il metodo può essere invocato solo dalle sottoclassi. \n D) Il metodo diventa opzionale nelle sottoclassi.");
